...
class __TwigTemplate_1fc509df0c7fedecf6da7bf6fe9823fc extends Twig_Template
{
    ...
    <div id=\"content\">
        ...
        if ($this->getContext($context, "profile")) {
            ...
            echo twig_escape_filter($this->env, twig_date_format_filter($this->getAttribute($this->getContext($context, "profile"), "time"), "r"), "html", null, true);
            echo "</strong>
                    </span>
                </p>
            </div>
